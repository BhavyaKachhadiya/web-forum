        ...
        <>
            ...
            <div className='h-[10rem]  bg-s-blue my-5 flex justify-evenly items-center flex-col'>
                ...
                <div className="post tilte">
                    <p className='font-medium lg:text-[1.3rem] text-[.8rem] text-center'>{params.p}</p>
                </div>
            </div>
            ...
            <div className='profile flex '>
                ...
                <div className="detail flex justify-between flex-col ml-6">
                    <div className="p1">
                        ...
                        <div className="post-date text-[.75rem] font-medium text-s-blue ">Feb 9 2024</div>
                    </div>
                    <div className="p2 flex gap-3">
                        <div className='view flex gap-2'>
                            ...
                            <div className="view-number text-[.75rem] font-medium text-s-blue "><span>1k</span></div>
                        </div>
